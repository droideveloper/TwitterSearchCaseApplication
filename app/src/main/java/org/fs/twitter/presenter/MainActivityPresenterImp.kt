...
@ForActivity
class MainActivityPresenterImp @Inject constructor(view: MainActivityView,
    private val navigationType: NavigationType<Tweet>) : AbstractPresenter<MainActivityView>(view), MainActivityPresenter {
